...
# -- v2 additions ----------------------------------------------------------------
GLYPHS.update({
    # structural literal markers
    "NUM":  [("L", 0.2, 0.8, 0.2, 0.3), ("L", 0.45, 0.8, 0.45, 0.2), ("L", 0.7, 0.8, 0.7, 0.4), ("L", 0.1, 0.85, 0.9, 0.85)],
    "STR":  [("P", [(0.12, 0.25), (0.88, 0.25), (0.88, 0.75), (0.12, 0.75)], False), ("L", 0.3, 0.5, 0.7, 0.5)],
    "TIME": [("C", 0.5, 0.5, 0.38, False), ("L", 0.5, 0.5, 0.5, 0.25), ("L", 0.5, 0.5, 0.7, 0.6), ("L", 0.1, 0.9, 0.9, 0.9)],
    "UNIT": [("L", 0.15, 0.3, 0.15, 0.7), ("L", 0.85, 0.3, 0.85, 0.7), ("L", 0.15, 0.5, 0.85, 0.5), ("L", 0.5, 0.4, 0.5, 0.6)],
    "EREF": [("P", [(0.15, 0.2), (0.6, 0.2), (0.6, 0.8), (0.15, 0.8)], False)] + _arrow(0.6, 0.35, 0.92, 0.1, 0.12),
    # relational: a bar joining two nodes, varied by the join
    "EQUAL":   [("D", 0.15, 0.5, 0.07), ("D", 0.85, 0.5, 0.07), ("L", 0.25, 0.42, 0.75, 0.42), ("L", 0.25, 0.58, 0.75, 0.58)],
    "GREATER": [("D", 0.15, 0.5, 0.09), ("D", 0.85, 0.5, 0.05), ("L", 0.28, 0.3, 0.72, 0.5), ("L", 0.28, 0.7, 0.72, 0.5)],
    "LESS":    [("D", 0.15, 0.5, 0.05), ("D", 0.85, 0.5, 0.09), ("L", 0.72, 0.3, 0.28, 0.5), ("L", 0.72, 0.7, 0.28, 0.5)],
    "PART":    [("P", [(0.1, 0.15), (0.9, 0.15), (0.9, 0.85), (0.1, 0.85)], False), ("P", [(0.15, 0.5), (0.5, 0.5), (0.5, 0.8), (0.15, 0.8)], True)],
    "HAS":     [("P", [(0.1, 0.15), (0.9, 0.15), (0.9, 0.85), (0.1, 0.85)], False), ("D", 0.5, 0.5, 0.14)],
    "MEMBER":  [("C", 0.5, 0.5, 0.4, False), ("D", 0.5, 0.5, 0.1), ("L", 0.5, 0.1, 0.5, 0.25)],
    "NEAR":    [("D", 0.35, 0.5, 0.1), ("D", 0.65, 0.5, 0.1)],
    "INSIDE":  [("P", [(0.1, 0.1), (0.9, 0.1), (0.9, 0.9), (0.1, 0.9)], False)] + _arrow(0.1, 0.9, 0.5, 0.5, 0.12),
    "OUTSIDE": [("P", [(0.1, 0.1), (0.9, 0.1), (0.9, 0.9), (0.1, 0.9)], False)] + _arrow(0.5, 0.5, 0.95, 0.05, 0.12),
    "ABOVE":   [("L", 0.1, 0.65, 0.9, 0.65), ("D", 0.5, 0.35, 0.12)],
    "BELOW":   [("L", 0.1, 0.35, 0.9, 0.35), ("D", 0.5, 0.65, 0.12)],
    "TOWARD":  [("D", 0.15, 0.5, 0.09)] + _arrow(0.3, 0.5, 0.9, 0.5, 0.14),
    # deictic: a pointing hand reduced to a dot and a pointer
    "SELF":      [("D", 0.5, 0.5, 0.12), ("C", 0.5, 0.5, 0.4, False)],
    "ADDRESSEE": [("C", 0.5, 0.5, 0.4, False)] + _arrow(0.5, 0.5, 0.92, 0.5, 0.12),
    "THIS":      [("D", 0.3, 0.5, 0.12)] + _arrow(0.9, 0.5, 0.45, 0.5, 0.12),
    "THAT":      [("D", 0.85, 0.5, 0.08)] + _arrow(0.1, 0.5, 0.7, 0.5, 0.12),
    "WHICH":     [("A", 0.5, 0.38, 0.22, 200, 90), ("D", 0.5, 0.82, 0.07)],
    "SAME":      [("L", 0.2, 0.35, 0.8, 0.35), ("L", 0.2, 0.65, 0.8, 0.65), ("D", 0.5, 0.5, 0.06)],
    "OTHER":     [("D", 0.25, 0.5, 0.1), ("C", 0.7, 0.5, 0.12, False)],
    "EACH":      [("D", 0.25, 0.3, 0.07), ("D", 0.5, 0.3, 0.07), ("D", 0.75, 0.3, 0.07), ("L", 0.15, 0.6, 0.85, 0.6)],
    "ANY":       [("C", 0.3, 0.5, 0.1, False), ("C", 0.7, 0.5, 0.1, False), ("D", 0.5, 0.5, 0.06)],
    "GENERIC":   [("P", [(0.5, 0.1), (0.9, 0.5), (0.5, 0.9), (0.1, 0.5)], False), ("D", 0.5, 0.5, 0.06)],
    # logical: gate-like forms
    "AND":     [("L", 0.2, 0.85, 0.5, 0.15), ("L", 0.5, 0.15, 0.8, 0.85), ("L", 0.32, 0.6, 0.68, 0.6)],
    "OR":      [("L", 0.2, 0.15, 0.5, 0.85), ("L", 0.5, 0.85, 0.8, 0.15)],
    "XOR":     [("L", 0.2, 0.15, 0.5, 0.85), ("L", 0.5, 0.85, 0.8, 0.15), ("L", 0.2, 0.05, 0.8, 0.05)],
    "IFF":     [("L", 0.15, 0.4, 0.85, 0.4), ("L", 0.15, 0.6, 0.85, 0.6), ("L", 0.15, 0.4, 0.05, 0.5), ("L", 0.15, 0.6, 0.05, 0.5), ("L", 0.85, 0.4, 0.95, 0.5), ("L", 0.85, 0.6, 0.95, 0.5)],
    "IMPLIES": [("L", 0.1, 0.4, 0.8, 0.4), ("L", 0.1, 0.6, 0.8, 0.6), ("L", 0.8, 0.4, 0.95, 0.5), ("L", 0.8, 0.6, 0.95, 0.5)],
    "ONLY":    [("D", 0.5, 0.5, 0.1), ("L", 0.2, 0.2, 0.2, 0.8), ("L", 0.8, 0.2, 0.8, 0.8)],
    "EXCEPT":  [("C", 0.5, 0.5, 0.35, False), ("D", 0.75, 0.25, 0.09), ("L", 0.65, 0.35, 0.85, 0.15)],
    # affect: a face reduced to a mouth line in a ring
    "JOY":      [("C", 0.5, 0.5, 0.4, False), ("A", 0.5, 0.45, 0.24, 20, 160)],
    "FEAR":     [("C", 0.5, 0.5, 0.4, False), ("C", 0.5, 0.6, 0.1, False), ("D", 0.36, 0.38, 0.05), ("D", 0.64, 0.38, 0.05)],
    "ANGER":    [("C", 0.5, 0.5, 0.4, False), ("L", 0.3, 0.35, 0.45, 0.42), ("L", 0.7, 0.35, 0.55, 0.42), ("L", 0.35, 0.68, 0.65, 0.68)],
    "TRUST":    [("C", 0.5, 0.5, 0.4, False), ("L", 0.3, 0.55, 0.7, 0.55), ("D", 0.5, 0.35, 0.06)],
    "SURPRISE": [("C", 0.5, 0.5, 0.4, False), ("C", 0.5, 0.62, 0.1, False), ("D", 0.36, 0.36, 0.06), ("D", 0.64, 0.36, 0.06), ("L", 0.5, 0.05, 0.5, 0.15)],
    "DISGUST":  [("C", 0.5, 0.5, 0.4, False), ("L", 0.3, 0.7, 0.45, 0.6), ("L", 0.45, 0.6, 0.55, 0.7), ("L", 0.55, 0.7, 0.7, 0.6)],
    "SADNESS":  [("C", 0.5, 0.5, 0.4, False), ("A", 0.5, 0.75, 0.24, 200, 340)],
    "CALM":     [("C", 0.5, 0.5, 0.4, False), ("L", 0.3, 0.55, 0.7, 0.55)],
})
